...
```{r plotting, eval = F, fig.height=4, fig.width=12}
...
```{r RandomWalk1, eval = F, fig.height=4, fig.width=12}
##############################
...
```{r RandomWalk2, eval = F, fig.height=4, fig.width=12}
##############################
...
```{r RandomWalk3, eval = F, fig.height=4, fig.width=12}
##############################
...
We first test the Hamiltonaian MH for the Gaussian with different tuning parameters $\sigma$ in the proposal distribution. 

```{r hmc1, fig.height=4, fig.width=12}
##############################
...
n = 2000
=======
>>>>>>> 3486a8ecc19e02b3208bf5da512cfb19c9f938fe
L = 10
delta = 0.1
K_old = 0 
K_prop = 0
...
K_prop = 0
<<<<<<< HEAD
trace2 = mcmc(x0, n, HMC_proposal, HMC_acceptance, dens)
=======
trace2 = mcmc(x0, n, Lproposal, Lacceptance, myGaussian)
>>>>>>> 3486a8ecc19e02b3208bf5da512cfb19c9f938fe
MCMCplots(trace2)
...
K_prop = 0
<<<<<<< HEAD
trace3 = mcmc(x0, n, HMC_proposal, HMC_acceptance, dens)
MCMCplots(trace3)
...
We continue with application of the Hamiltonian MH to the Multimodal with different tuning parameters $\sigma$ in the proposal distribution. 

```{r hmc2, fig.height=4, fig.width=12}
##############################
...
K_old = 0 
K_prop = 0
trace4 = mcmc(x0, n, HMC_proposal, HMC_acceptance, myMultimodal)
MCMCplots(trace4)
>>>>>>> 3486a8ecc19e02b3208bf5da512cfb19c9f938fe
```
...
```{r hmc3, fig.height=4, fig.width=12}
##############################
...
K_old = 0 
K_prop = 0
trace4 = mcmc(x0, n, HMC_proposal, HMC_acceptance, myVolcano)
MCMCplots(trace4)
>>>>>>> 3486a8ecc19e02b3208bf5da512cfb19c9f938fe
```
