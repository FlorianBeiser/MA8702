...
RWproposal <- function(x_old){
  x_prop = x_old 
  x_prop[1] = rnorm(1, mean=x_old[1], sd=sqrt(sigma))
  x_prop[2] = rnorm(1, mean=x_old[2], sd=sqrt(sigma))
  return(x_prop)
}
