...
```{r Langevin1, eval = F, fig.height=4, fig.width=12}
##############################
...
```{r Langevin2, eval = F, fig.height=4, fig.width=12}
##############################
...
```{r Langevin3, eval = F, fig.height=4, fig.width=12}
##############################
# Testing Langevin for Multimodal
...
K_old = 0 
K_prop = 0
trace1 = mcmc(x0, n, HMC_proposal, HMC_acceptance, dens)
MCMCplots(trace1)
